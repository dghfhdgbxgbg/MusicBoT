...
EVAL_USERS = list(map(int, getenv("EVAL_USERS", "5810668543 7045191057").split()))
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+lx96AEb1Ch1lZTNl")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+lx96AEb1Ch1lZTNl")

SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5810668543 7045191057").split()))
